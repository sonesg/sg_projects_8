...
//    protected LinkedHashSet<String> predmetiCetvrtaGodDizajn;
    ...
    public int onStartCommand(Intent intent, final int flags, int startId) {
        ...
        if (ScheduleService.CheckNetwork.isInternetAvailable(ScheduleService.this)) {
            //delete all data from database
            deleteDataAll();
        }

        sharedPreferences2 = getSharedPreferences(SHARED_PREFERENCES_FILE_3, MODE_PRIVATE);
        ...
        readJSON = new ReadJSON() {
            ...
            protected void onPostExecute(String content) {
                ...
                Log.i("START", "NOW_SCHEDULE_SERVICE");
...
//                    predmetiCetvrtaGodDizajn = new LinkedHashSet<>();
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        // and Schedule attributes from the editor are the values.
...
//                        values.put(SubjectContract.SubjectEntry.COLUMN_NAME_EXAMP, (String) null);
//                        values.put(SubjectContract.SubjectEntry.COLUMN_DATE_TIME_EXAMP, (String) null);
//                        values.put(SubjectContract.SubjectEntry.COLUMN_UCIONICA_EXAMP, (String) null);
//                        values.put(SubjectContract.SubjectEntry.COLUMN_PROFESSOR_EXAMP, (String) null);
//                        values.put(SubjectContract.SubjectEntry.COLUMN_TYPE_EXAMP, (String) null);
...
//                        Uri newUri = getContentResolver().insert(SubjectEntry.CONTENT_URI, values);
                    ...
                    if (nastavnici != null && nastavnici.size() > 0
                        ...
                        Log.i("START", "START_FINAL_SCHEDULE_SERVICE");

//                        Log.i("CONTENT_EXAMS", predmetiPrvaGodNaukeMreze.toString());
...
//                                predmetiPrvaGodDizajnArrayList = new ArrayList<>(Arrays.asList(predmetiPrvaGodDizajnArray));
                        ...
                        Log.i("START", "FINISH_SCHEDULE_SERVICE");

                        FirstScreen.btnDizajn.setEnabled(true);
                        FirstScreen.btnNauke.setEnabled(true);
                        FirstScreen.btnMreze.setEnabled(true);
                        FirstScreen.btnTehnologije.setEnabled(true);
...
//                        Log.i("MIMIVAU","usao5");
                        ...
                        if (sharedPreferences2.getBoolean(PROGRESS_BAR, false)) {
                            if (ScheduleDataActivity.progressBar != null)
                                ScheduleDataActivity.progressBar.setVisibility(View.GONE);
                            if (ExamDataActivity.progressBar != null)
                                ExamDataActivity.progressBar.setVisibility(View.GONE);
                        }
        ...
        if (ScheduleService.CheckNetwork.isInternetAvailable(ScheduleService.this)) {
            ...
            Log.i("START", "NOW_CHECK_INTERNET_SCHEDULE_SERVICE");
...
//            editor.apply();
            ...
            if(toast!=null)
                toast.cancel();
            toast = Toast.makeText(ScheduleService.this, "Nema internet konekcije", Toast.LENGTH_SHORT);
            toast.show();
        }
        //Ukoliko stavim da je START_STICKY onda ce se ovaj servis izvrsavati svaki put kad izadjem iz aplikacije
        //Sa ovim START_NOT_STICKY nece,samo se izvrsava pri prvom ulasku
...
//    private static String readURL2(String url){
...
//                    final String respons = Objects.requireNonNull(response.body()).string();
//                    k[0] = respons;
//                }
//            }
//        });
...
//                        Toast.LENGTH_SHORT).show();
        ...
        Intent e = new Intent(ScheduleService.this, ExamService.class);
        ScheduleService.this.startService(e);
    }
